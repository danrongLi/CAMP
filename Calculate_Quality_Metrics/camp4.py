...
metacell_partition = pd.read_csv(
    "/storage/home/dvl5760/work/SEACells/customized_metacell/human_fetal_atlas/output/edit_5_partitions_full_metacell.csv",
    index_col=0
)
...
m_list = [24729,16486,12364,9891,8243,7065,4945, 3297, 2472, 1978, 1648, 1413, 1236, 1099, 989, 899]
...
out_path = os.path.join(out_dir, "camp4_metrics_human_fetal_atlas.csv")

...
metacell_partition = pd.read_csv(
    "/storage/home/dvl5760/work/SEACells/seacell_default_output/human_fetal_atlas/seacell_default_partition.csv",
    index_col=0
)
...
m_list = [899, 989, 1099, 1236, 1413, 1648, 1978, 2472, 3297, 4945]
g_list = metacell_partition.columns[0:len(m_list)]
...
out_path = os.path.join(out_dir, "seacells_metrics_human_fetal_atlas.csv")

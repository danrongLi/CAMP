...
#metacell_partition = pd.read_csv(
#    "/storage/home/dvl5760/work/SEACells/customized_metacell/human_fetal_atlas/output/edit_4_add_simi_partitions.csv",
#    index_col=0
#)

metacell_partition = pd.read_csv(
    "/storage/home/dvl5760/work/SEACells/customized_metacell/human_fetal_atlas/output/edit_4_add_simi_partitions_large_metacell.csv",
    index_col=0
)
...
out_path = os.path.join(out_dir, "camp2_metrics_human_fetal_atlas_large_metacell.csv")

...
#)
metacell_partition = pd.read_csv(
    "/storage/home/dvl5760/work/SEACells/customized_metacell/MetaQ/save/human_fetal_atlas_combined_metacell_labels_large_metacell.csv",
    index_col=0
)
...
out_path = os.path.join(out_dir, "metaQ_metrics_human_fetal_atlas_large_metacell.csv")
